...
L["Combat Mode"] = "战斗模式"
L["opt_combatmode_desc"] = "进入战斗时自动切换到|cffffbb00当前|r集合和此模式。"
L["Wipe Mode"] = "团灭模式"
L["opt_wipemode_desc"] = "团灭后自动切换到|cffffbb00当前|r集合和此模式。"
...
L["opt_autocurrent_desc"] = "每当战斗开始这个窗口自动切换到|cffffbb00当前|r片段。"
L["Auto Hide"] = "自动隐藏"
...
L["Shorten menus"] = "短菜单"
L["opt_shortmenu_desc"] = "从Skada菜单中移除模式和分段菜单，以降低其高度。仍可使用窗口按钮访问菜单。"
L["Transliterate"] = "音译"
...
L["|cff00ff00Left-Click|r to toggle windows."] = "|cff00ff00左键|r：开关窗口"
L["|cff00ff00Ctrl+Left-Click|r to show/hide windows."] = "|cff00ff00Ctrl+左键|r：显示/隐藏窗口。"
L["|cff00ff00Shift+Left-Click|r to reset."] = "|cff00ff00Shift+左键|r：重置"
L["|cff00ff00Right-Click|r to open menu."] = "|cff00ff00右键|r：打开菜单"
-- skada menu
...
L["|cffffbb00%s|r - |cff00ff00Phase %s|r started."] = "|cffffbb00%s|r - |cff00ff00第 %s|r 开始。"
L["|cffffbb00%s|r - |cff00ff00Phase %s|r stopped."] = "|cffffbb00%s|r - |cff00ff00第 %s|r 停止。"
L["|cffffbb00%s|r - |cff00ff00Phase %s|r resumed."] = "|cffffbb00%s|r - |cff00ff00第 %s|r 恢复。"
...
L["|cffffbb00Boss First Target|r: %s"] = "|cffffbb00BOSS第一个目标|r：%s"
