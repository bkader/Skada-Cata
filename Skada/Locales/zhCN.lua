...
L["Active Time"] = "活跃时间"
L["Segment Time"] = "分段时间"
L["Click for |cff00ff00%s|r"] = "点击后为 |cff00ff00%s|r"
L["Shift-Click for |cff00ff00%s|r"] = "Shift+点击后为 |cff00ff00%s|r"
L["Control-Click for |cff00ff00%s|r"] = "Ctrl+点击后为 |cff00ff00%s|r"
L["Alt-Click for |cff00ff00%s|r"] = "Alt+点击后为 |cff00ff00%s|r"
...
L["Combat Mode"] = "战斗模式"
L["Automatically switch to set |cffffbb00Current|r and this mode when entering combat."] = "进入战斗时自动切换到|cffffbb00当前|r集合和此模式。"
L["Wipe Mode"] = "团灭模式"
L["Automatically switch to set |cffffbb00Current|r and this mode after a wipe."] = "团灭后自动切换到|cffffbb00当前|r集合和此模式。"
...
L["Whenever a combat starts, this window automatically switches to |cffffbb00Current|r segment."] = "每当战斗开始这个窗口自动切换到|cffffbb00当前|r片段。"
L["Auto Hide"] = "自动隐藏"
...
L["tentativecombatstart_desc"] = [[Skada通常使用非常保守（简单）的战斗侦测方案，在团队副本中效果最佳。通过此选项，Skada可尝试模拟其他伤害统计插件。这在五人本中很有效, 但对于BOSS战则毫无意义。]]
L["Autostop"] = "自动停止"
...
L["Configure"] = "配置"
L["Open Config"] = "打开配置"
L.Config_Button_Desc = "打开配置窗口。"
L.Reset_Button_Desc = "重置除标记为保留之外的全部数据。"
L["Segment"] = "分段"
L["Jump to a specific segment."] = "跳转至一个指定分段。"
L.Segment_Button_Desc = "跳转至一个指定分段。\n|cff00ff00中键|r: |cffffbb00当前|r片段。"
L["Mode"] = "模式"
L["Jump to a specific mode."] = "跳转至一个指定模式。"
L["Report"] = "报告"
L.Report_Button_Desc = "打开一个可以通过各种方式向他人报告数据的对话框。\n|cff00ff00Shift-点击后为|r: 快速报告."
L["Stop"] = "停止"
L.Stop_Button_Desc = "停止或继续当前分段。在团灭后很有用。可在设置中设为自动停止。"
...
L["Ignore Pets"] = "忽略宠物"
L["Disable tracking pets threat and only watch players."] = "禁用跟踪宠物威胁，只看玩家。"
L["> Pull Aggro <"] = ">获得仇恨<"
...
L["Constantly clear the combat log instead of only when it breaks."] = "不断清除战斗日志，而不是仅在它损坏时清除。"
...
L["Opacity"] = "不透明度"
L["Notifications"] = "通知"
L["Uses visual notifications instead of chat window messages whenever applicable."] = "在适用时使用视觉通知而不是聊天窗口消息。"
