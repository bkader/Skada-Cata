...
L["Automatically switch to set |cffffbb00Current|r' and this mode when entering combat."] = "Bei Kampfbeginn automatisch auf das Segment des |cffffbb00Momentaner Kampf|r und den eingestellten Anzeigemodus wechseln."
L["Wipe Mode"] = "Niederlagenanzeigemodus"
L["Automatically switch to set |cffffbb00Current|r' and this mode after a wipe."] = "Wechselt bei einer Niederlage automatisch auf das Segment des |cffffbb00Momentaner Kampf|r und den hier eingestellten Anzeigemodus ."
...
L["Whenever a combat starts, this window automatically switches to |cffffbb00Current|r segment."] = "Wenn ein Kampf beginnt, schaltet das Fenster automatisch zum |cffffbb00Momentaner Kampf|r."
...
L.Config_Button_Desc = "Öffnet das Konfigurationsfenster."
L.Reset_Button_Desc = "Setzt alle Kampfdaten zurück mit Ausnahme der markierten, sie werden beibehalten."
L["Segment"] = "Segment"
L["Jump to a specific segment."] = "Wechseln zu einem bestimmten Segment."
L.Segment_Button_Desc = "Wechseln zu einem bestimmten Segment.\n|cff00ff00Mittelklick|r um zum |cffffbb00Momentaner Kampf|r."
L["Mode"] = "Modus"
L["Jump to a specific mode."] = "In einen bestimmten Modus springen."
L["Report"] = "Bericht"
L.Report_Button_Desc = "Öffnet ein Dialogfeld, damit Sie Ihre Daten an andere auf verschiedene Weise mitteilen können.\n|cff00ff00Shift-Klick|r für Schnellbericht."
L["Stop"] = "Stopp"
L.Stop_Button_Desc = "Stoppt oder setzt das aktuelle Segment fort. Nützlich zur Diskontierung von Daten nach einem Wipe. Kann auch so eingestellt werden, dass in den Einstellungen automatisch gestoppt wird."
...
L["Disable tracking pets threat and only watch players."] = "Deaktiviere die Verfolgung von Haustieren und beobachte nur Spieler."
...
L["%s's debuffs on %s"] = "%s Debuffs von %s"
...
L["Constantly clear the combat log instead of only when it breaks."] = "Löschen Sie das Kampfprotokoll ständig, anstatt nur, wenn es kaputt geht."
...
L["Uses visual notifications instead of chat window messages whenever applicable."] = "Verwendet visuelle Benachrichtigungen anstelle von Chatfenster-Nachrichten, wann immer zutreffend."
