...
L["Combat Mode"] = true
L["Automatically switch to set |cffffbb00Current|r and this mode when entering combat."] = true
L["Wipe Mode"] = true
L["Automatically switch to set |cffffbb00Current|r and this mode after a wipe."] = true
L["Return after combat"] = true
L["Return to the previous set and mode after combat ends."] = true
L["Auto switch to current"] = true
L["Whenever a combat starts, this window automatically switches to |cffffbb00Current|r segment."] = true
L["Auto Hide"] = true
...
L["Configure"] = true
L["Open Config"] = true
L.Config_Button_Desc = "Opens the configuration window."
L.Reset_Button_Desc = "Resets all fight data except those marked as kept."
L["Segment"] = true
L["Jump to a specific segment."] = true
L.Segment_Button_Desc = "Jump to a specific segment.\n|cff00ff00Middle-Click|r for |cffffbb00current|r segment."
L["Mode"] = true
L["Jump to a specific mode."] = true
L["Report"] = true
L.Report_Button_Desc = "Opens a dialog that lets you report your data to others in various ways.\n|cff00ff00Shift-Click|r to Quick Report."
L["Stop"] = "Stop/Resume"
L.Stop_Button_Desc = "Stops or resumes the current segment. Useful for discounting data after a wipe. Can also be set to automatically stop in the settings."
