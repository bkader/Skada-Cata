...
L["Automatically switch to set |cffffbb00Current|r and this mode when entering combat."] = "Passe automatiquement au segment |cffffbb00Actuel|r et au mode choisi ci-dessous quand vous entrez en combat."
L["Wipe Mode"] = "Mode wipe"
L["Automatically switch to set |cffffbb00Current|r and this mode after a wipe."] = "Passe automatiquement au segment |cffffbb00Actuel|r et à ce mode après un wipe."
...
L["Whenever a combat starts, this window automatically switches to |cffffbb00Current|r segment."] = "Une fois en combat, cette fenêtre retourne automatiquement au segment |cffffbb00Actuel|r."
...
L["Class colors:\n|cFFF58CBAKader|r - 5.71M (21.7K)\n\nWithout:\nKader - 5.71M (21.7K)"] = "Couleurs de classes:\n|cFFF58CBAKader|r - 5.71M (21.7K)\nSans:\nKader - 5.71M (21.7K)"
...
L.Config_Button_Desc = "Ouvre la fenêtre de configuration."
L.Reset_Button_Desc = "Réinitialise les données de tous les combats sauf ceux que vous avez choisi de garder."
L["Segment"] = "Segment"
L["Jump to a specific segment."] = "Vous permet de sélectionner un segment spécific."
L.Segment_Button_Desc = "Vous permet de sélectionner un segment spécific.\n|cff00ff00Clic du milieu|r pour sélectionner le segment |cffffbb00Actuel|r."
L["Mode"] = "Mode"
L["Jump to a specific mode."] = "Vous permet de sélectionner un mode spécific."
L["Report"] = "Rapport"
L.Report_Button_Desc = "Ouvre la fenêtre qui vous permet de rapporter les données aux autres de différentes manières.\n|cff00ff00Shift-clic|r pour un Rapport Rapide."
L["Stop"] = "Arrêter/Reprendre"
L.Stop_Button_Desc = "Arrête ou reprend le segment en cours. Utile pour arrêter la collecte des données après un wipe. L'arrêt automatique peut être activé dans les paramètres."
...
L["Disable tracking pets threat and only watch players."] = "Désactive la menace des familiers et ne surveille que celle des joueurs."
...
L["%s's healing spells"] = "Sorts de soin \1242 %s"
L["%s's healed targets"] = "Cibles soignées par %s"
L["%s's healing on %s"] = "Soins \1242 %s sur %s"
L["HPS"] = "SPS"
...
L["%s's overheal spells"] = "Sorts d'excès de soin \1242 %s"
L["%s's overhealed targets"] = "Cibles soignées en excès par %s"
L["%s's overhealing on %s"] = "Soins excessifs \1242 %s sur %s"
...
L["%s's heal and overheal spells"] = "Sorts de soin \1242 %s"
L["%s's healed and overhealed targets"] = "Cibles soignées par %s"
L["%s's healing and overhealing on %s"] = "Soins et excès de soin \1242 %s sur %s"
...
L["%s's absorb spells"] = "Sorts d'absorption \1242 %s"
L["%s's absorbs on %s"] = "Absorptions \1242 %s sur %s"
...
L["%s's absorb and healing spells"] = "Sorts d'absorption et de soin \1242 %s"
L["%s's absorbed and healed targets"] = "Cibles absorbées et soignées par %s"
L["%s's absorbs and healing on %s"] = "Absorptions et soins \1242 %s sur %s"
...
L["%s's debuffs"] = "Debuffs \1242 %s"
L["%s's debuffs on %s"] = "Debuffs \1242 %s sur %s"
...
L["%s's damage"] = "Dégâts \1242 %s"
L["%s's <%s> damage"] = "Dégâts \1242 %s par <%s>"
L["%s's <%s> damage on %s"] = "Dégâts \1242 %s <%s> sur %s"
...
L["%s's damage on %s"] = "Dégâts \1242 %s sur %s"
...
L["%s's <%s> mitigated damage"] = "Dégâts mitigés \1242 %s <%s>"
...
L["Constantly clear the combat log instead of only when it breaks."] = "Effacer constamment le journal de combat au lieu de seulement quand il bugge."
