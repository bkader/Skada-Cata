...
L["Combat Mode"] = "戰鬥模組"
L["Automatically switch to set |cffffbb00Current|r and this mode when entering combat."] = "當進入戰鬥時，自動切換|cffffbb00目前的|r以及選擇的模組。"
L["Wipe Mode"] = "清除模組"
L["Automatically switch to set |cffffbb00Current|r and this mode after a wipe."] = "清除後，自動切換至|cffffbb00目前的|r模組。"
...
L["Whenever a combat starts, this window automatically switches to |cffffbb00Current|r segment."] = "不管何時進入戰鬥，這個視窗會自動切換到|cffffbb00目前的|r片段"
L["Auto Hide"] = "自動隱藏"
...
L["tentativecombatstart_desc"] = [[Skada在團隊副本中經常性的使用一種非常傳統(簡易)的戰鬥檢測機制。勾選此選項Skada將嘗試模仿其他的傷害統計插件，使其有效運用在雜兵戰, 但與首領戰則是無效的。]]
L["Autostop"] = "自動停止"
...
L["Configure"] = "設定"
L["Open Config"] = "打開配置"
L.Config_Button_Desc = "讓你配置此啟用的Skada視窗。"
L.Reset_Button_Desc = "除標記為保留外重置全部戰鬥數據。"
L["Segment"] = "分段"
L["Jump to a specific segment."] = "跳至特定區段。"
L.Segment_Button_Desc = "跳至特定區段。\n|cff00ff00中鍵|r: |cffffbb00目前的|r片段"
L["Mode"] = "模組"
L["Jump to a specific mode."] = "跳至特定模組。"
L["Report"] = "報告"
L.Report_Button_Desc = "打開一個對話框，讓你以各種方式報告數據給他人。\n|cff00ff00Shift-點擊後為|r: 快速報告。"
L["Stop"] = "停止"
L.Stop_Button_Desc = "停止或恢復當前區段。用於滅團後停止收集數據。也可在設置中設為自動停止。"
...
L["Ignore Pets"] = "忽略寵物"
L["Disable tracking pets threat and only watch players."] = "禁用跟踪寵物威脅，只看玩家。"
L["> Pull Aggro <"] = ">獲得仇恨<"
