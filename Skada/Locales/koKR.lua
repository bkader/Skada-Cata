...
L["|cffffbb00Boss First Target|r: %s (%s)"] = "|cffffbb00보스의 첫 번째 타겟|r: %s (%s)"
L["HoT"] = " (지속 치유)"
L["DoT"] = " (지속 피해)"
L["Hits"] = "횟수"
L["Normal Hits"] = "일반 적중"
...
L["Combat Mode"] = "전투 모드"
L["Automatically switch to set |cffffbb00Current|r and this mode when entering combat."] = "전투 시작시 자동으로 |cffffbb00현재|r 세분화의 이 모드로 전환합니다."
L["Wipe Mode"] = "전멸 모드"
L["Automatically switch to set |cffffbb00Current|r and this mode after a wipe."] = "전멸 후 자동으로 |cffffbb00현재|r 세분화의 이 모드로 전환합니다."
...
L["Whenever a combat starts, this window automatically switches to |cffffbb00Current|r segment."] = "전투가 시작되면 자동으로 |cffffbb00현재|r 전투 세분화로 변경합니다."
L["Auto Hide"] = "자동 숨기기"
...
L["Removes mode and segment menus from Skada menu to reduce its height. Menus are still accessible using window buttons."] = [[Skada 메뉴에서 모드 및 세그먼트 메뉴를 제거하여 높이를 줄입니다.
...
L["Configure"] = "설정"
L["Open Config"] = "구성 열기"
L.Config_Button_Desc = "설정 창 열기"
L.Reset_Button_Desc = "유지하도록 설정한 것을 제외하고 모든 전투 자료를 초기화합니다."
L["Segment"] = "세분화"
L["Jump to a specific segment."] = "특정 세분화로 변경합니다."
L.Segment_Button_Desc = "특정 세분화로 변경합니다.\n|cff00ff00가운데 클릭|r -> |cffffbb00현재|r 전투"
L["Mode"] = "모드"
L["Jump to a specific mode."] = "특정 모드로 변경합니다."
L["Report"] = "보고서"
L.Report_Button_Desc = "다양한 방법으로 다른 사람에게 당신의 자료를 보고할 수 있는 대화창을 엽니다.\n|cff00ff00Shift-클릭|r -> 퀵 리포트."
L["Stop"] = "중지"
L.Stop_Button_Desc = "현재 세분화를 중지하거나 재개합니다. 전멸 후 자료를 제외하는 데 유용합니다. 설정에서 자동으로 중지하도록 설정할 수 있습니다."
...
L["Ignore Pets"] = "펫 무시"
L["Disable tracking pets threat and only watch players."] = "애완 동물 위협 추적을 비활성화하고 플레이어만 관찰합니다."
L["> Pull Aggro <"] = "> 어그로 획득 <"
...
L["%s's healing spells"] = "%s 치유 주문"
L["%s's healed targets"] = "%s의 치유 대상"
L["%s's healing on %s"] = "%2$s에서 %1$s의 치유"
L["HPS"] = "HPS"
...
L["%s's absorb and healing spells"] = "%s - 주문 흡수 및 치유"
L["%s's absorbed and healed targets"] = "%s - 대상 흡수 및 치유"
L["%s's absorbs and healing on %s"] = "%1$s의 %2$s 흡수 및 치유"
...
L["Constantly clear the combat log instead of only when it breaks."] = "전투 기록이 깨졌을 때만 지우는 대신 지속적으로 지우십시오."
