local L = LibStub("AceLocale-3.0"):NewLocale("Skada", "koKR")
...
L["Use a custom color for your bar."] = "내 막대에 사용자 지정 색상을 사용합니다."
L["My Color"] = "나의 색깔"
...
L["%s's buffs"] = "%s 버프"
L["Debuffs"] = "디버프"
L["Debuff spell list"] = "디버프 주문"
L["Debuff target list"] = "디버프의 대상"
L["Debuff source list"] = "디버프의 근원"
